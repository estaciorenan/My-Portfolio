...
import { DataWorks } from "@/app/interface/interface";

const Modal = ({ name, image, information, technologies, activities }: DataWorks) => {
                            ...
                            <div className="flex ">
                                ...
                                <div className="flex-col">
                                    ...
                                    <div>
                                        ...
                                        <p>Tecnologia: {technologies}</p>
                                        <p>Função: {activities}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
